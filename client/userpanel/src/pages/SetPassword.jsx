...
function SetPassword() {
  ...
  const handleSetPassword = async () => {
    ...
    try {
      const res = await API.post("/users/register/set-password", {
        userId,
        password,
      });
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-green-100/80 via-emerald-100/80 to-green-100/80 px-4 py-8 relative overflow-hidden">
      {/* Animated background elements matching navbar */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-10 left-10 w-4 h-4 bg-emerald-300 rounded-full opacity-20 animate-pulse"></div>
        <div className="absolute top-20 right-20 w-6 h-6 bg-green-300 rounded-full opacity-25 animate-bounce"></div>
        <div className="absolute bottom-32 left-1/4 w-3 h-3 bg-emerald-400 rounded-full opacity-30 animate-pulse"></div>
        <div className="absolute bottom-20 right-1/3 w-5 h-5 bg-green-400 rounded-full opacity-20 animate-bounce"></div>
        <div className="absolute top-1/2 left-16 w-2 h-2 bg-emerald-500 rounded-full opacity-25 animate-pulse"></div>
        <div className="absolute top-1/3 right-16 w-3 h-3 bg-green-500 rounded-full opacity-30 animate-bounce"></div>
      </div>
      ...
      <div className="bg-gradient-to-br from-white/90 via-emerald-50/90 to-green-50/90 backdrop-blur-lg shadow-2xl p-8 rounded-2xl w-full max-w-md border border-white/30 relative">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-green-700">
            Set Your Password
          </h2>
        ...
        <div className="bg-gradient-to-r from-emerald-50/70 to-green-50/70 backdrop-blur-sm rounded-lg p-4 mb-4 border border-emerald-200/30">
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div
              className={`flex items-center ${
                password.length >= 8 ? "text-emerald-600" : "text-emerald-400"
              }`}
            >
            ...
            <div
              className={`flex items-center ${
                /[A-Z]/.test(password) ? "text-emerald-600" : "text-emerald-400"
              }`}
            >
            ...
            <div
              className={`flex items-center ${
                /\d/.test(password) ? "text-emerald-600" : "text-emerald-400"
              }`}
            >
            ...
            <div
              className={`flex items-center ${
                /[@$!%*?&]/.test(password) ? "text-emerald-600" : "text-emerald-400"
              }`}
            >
              <span className="mr-1">
                {/[@$!%*?&]/.test(password) ? "✓" : "○"}
        ...
        <Button text="Set Password" onClick={handleSetPassword} />
