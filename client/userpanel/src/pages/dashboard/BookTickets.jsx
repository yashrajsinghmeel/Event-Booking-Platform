          ...
          {ticketOptions.map((ticket, index) => {
            ...
            return (
              ...
              >
                {/* Badge */}
                <div
                  className={`absolute top-4 right-4 ${style.badgeColor} text-white px-3 py-1 rounded-full text-sm font-semibold animate-pulse`}
                >
                  {style.badge}
                </div>
                ...
                <div className="relative z-10 text-center">
                  {/* Icon */}
                  <div
                    className={`text-6xl md:text-7xl lg:text-8xl mb-6 ${style.textColor} animate-icon-bounce`}
                  >
                    {style.icon}
                  </div>
                  ...
                  {/* Event title */}
                  <h3
                    className={`text-xl md:text-2xl lg:text-3xl font-bold ${style.textColor} mb-4`}
                  >
                    {ticket.title}
                  </h3>
                  ...
                  {/* Current price */}
                  <div
                    className={`text-3xl md:text-4xl lg:text-5xl font-bold ${style.priceColor} mb-6 animate-price-pulse`}
                  >
                    ₹{ticket.price}
                  </div>
                  ...
                  <button
                    onClick={() =>
                      handleBook(ticket.title, ticket.price, ticket._id)
                    }
                    className={`w-full py-3 md:py-4 px-6 bg-gradient-to-r ${style.badgeColor.replace(
                      "bg-",
                      "from-"
                ...
                {/* Animated border */}
                <div
                  className={`absolute inset-0 border-2 border-transparent bg-gradient-to-r ${style.borderColor.replace(
                    "border-",
                    "from-"
                  )}-300 via-${style.borderColor.replace(
                    "border-",
                    ""
                  )}-400 to-${style.borderColor.replace(
                    "border-",
                    ""
